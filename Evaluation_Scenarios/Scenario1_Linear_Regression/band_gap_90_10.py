#!/usr/bin/env python3
"""
Compare FTCP vs SSL Features for Band Gap Prediction (90/10 Split)
=============================================================================
...
print("\n📂 Loading FTCP data...")
print("   [1/5] Loading Train_FTCP_Data.npy (this is LARGE, ~18GB for 90% split)...")
...
# Save JSON results
json_path = results_dir / "band_gap_comparison_results_90_10.json"
...
csv_path = results_dir / "band_gap_comparison_summary_90_10.csv"
...
sys.stdout.flush()
plt.tight_layout()
plot_path = results_dir / "band_gap_comparison_plots_90_10.png"
...
Files Generated:
- band_gap_comparison_results_90_10.json (detailed metrics)
- band_gap_comparison_summary_90_10.csv (tabular summary)
- band_gap_comparison_plots_90_10.png (visualizations)
...
print("\nFiles created:")
print("  - band_gap_comparison_results_90_10.json")
print("  - band_gap_comparison_summary_90_10.csv")
print("  - band_gap_comparison_plots_90_10.png")
