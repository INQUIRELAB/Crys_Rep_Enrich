#!/usr/bin/env python3
"""
Compare FTCP vs SSL Features for Formation Energy Prediction (60/40 Split)
=============================================================================
...
data_root = workspace_root / "Data/Splitted_Data/Split_40Test_60Train"
...
print("\n📂 Loading FTCP data...")
print("   [1/5] Loading Train_FTCP_Data.npy (this is LARGE, ~16GB for 70% split)...")
...
print("\n" + "=" * 80)
print("EXPERIMENT 1: TRAINING ON FTCP DATA (60/40 Split)")
print("=" * 80)
sys.stdout.flush()
...
print("   ⚠️  WARNING: This will take 10-30 minutes! Be patient!")
...
print("\n" + "=" * 80)
print("EXPERIMENT 2: TRAINING ON SSL FEATURES (60/40 Split)")
print("=" * 80)
sys.stdout.flush()
...
print("   Expected time: 2-10 minutes (much faster than FTCP!)")
print(f"   ⏰ Training started at: {pd.Timestamp.now().strftime('%H:%M:%S')}")
print("   Computing (X^T X)^(-1) X^T y for linear regression...")
print("   You will see progress every 20 seconds below:")
print("")
...
print("\n" + "=" * 80)
print("COMPARISON: FTCP vs SSL FEATURES (60/40 Split)")
print("=" * 80)
sys.stdout.flush()
...
# Save JSON results
json_path = results_dir / "comparison_results_60_40.json"
...
csv_path = results_dir / "comparison_summary_60_40.csv"
results_df.to_csv(csv_path, index=False)
print(f"✅ Saved summary CSV: {csv_path}")

# Save predictions
np.save(results_dir / "ftcp_test_predictions_60_40.npy", y_test_pred_ftcp)
np.save(results_dir / "features_test_predictions_60_40.npy", y_test_pred_features)
np.save(results_dir / "test_true_labels_60_40.npy", y_test)
np.save(results_dir / "test_material_ids_60_40.npy", y_test_ids)
...
ax1.set_title(f'FTCP (60/40): Predicted vs Actual\nR² = {test_r2_ftcp:.4f}')
...
ax2.set_title(f'SSL Features (60/40): Predicted vs Actual\nR² = {test_r2_features:.4f}')
...
ax5.set_title('Performance Comparison (60/40 Test Set)')
ax5.set_xticks(x)
...
ax6.set_title('Computational Efficiency (60/40 Split)')
ax6.set_xticks(x)
...
sys.stdout.flush()
plt.tight_layout()
plot_path = results_dir / "comparison_plots_60_40.png"
...
report = f"""
{'=' * 80}
FORMATION ENERGY PREDICTION: FTCP vs SSL FEATURES (60/40 Split)
{'=' * 80}

Experiment Date: {pd.Timestamp.now().strftime('%Y-%m-%d %H:%M:%S')}
Data Split: 70% Train ({len(y_train):,} samples) / 30% Test ({len(y_test):,} samples)
...
Files Generated:
- comparison_results_60_40.json (detailed metrics)
- comparison_summary_60_40.csv (tabular summary)
- comparison_plots_60_40.png (visualizations)
- *_60_40.npy (predictions for further analysis)

{'=' * 80}
"""

report_path = results_dir / "COMPARISON_REPORT_60_40.txt"
...
print("\nFiles created:")
print("  - comparison_results_60_40.json")
print("  - comparison_summary_60_40.csv")
print("  - comparison_plots_60_40.png")
print("  - COMPARISON_REPORT_60_40.txt")
