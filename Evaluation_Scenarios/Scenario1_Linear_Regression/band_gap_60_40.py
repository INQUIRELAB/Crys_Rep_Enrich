#!/usr/bin/env python3
"""
Compare FTCP vs SSL Features for Band Gap Prediction (60/40 Split)
=============================================================================
This script trains the SAME regression model on both FTCP and SSL features
to fairly compare which data representation is better for predicting band gap.

Conditions:
- Same model (Linear Regression)
- Same hyperparameters
- Same data split (60/40)
- Same labels (Band Gap)
...
print("=" * 80)
print("COMPARING FTCP vs SSL FEATURES FOR BAND GAP PREDICTION")
...
print("\n📂 Loading FTCP data...")
print("   [1/5] Loading Train_FTCP_Data.npy (this is LARGE, ~18GB for 60% split)...")
...
# Save JSON results
json_path = results_dir / "band_gap_comparison_results_60_40.json"
...
csv_path = results_dir / "band_gap_comparison_summary_60_40.csv"
...
sys.stdout.flush()
plt.tight_layout()
plot_path = results_dir / "band_gap_comparison_plots_60_40.png"
...
Files Generated:
- band_gap_comparison_results_60_40.json (detailed metrics)
- band_gap_comparison_summary_60_40.csv (tabular summary)
- band_gap_comparison_plots_60_40.png (visualizations)
...
print("\nFiles created:")
print("  - band_gap_comparison_results_60_40.json")
print("  - band_gap_comparison_summary_60_40.csv")
print("  - band_gap_comparison_plots_60_40.png")
