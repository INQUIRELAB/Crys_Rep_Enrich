#!/usr/bin/env python3
"""
Compare FTCP vs SSL Features for Formation Energy Prediction (70/30 Split)
=============================================================================
...
data_root = workspace_root / "Data/Splitted_Data/Split_30Test_70Train"
...
print("\n" + "=" * 80)
print("EXPERIMENT 1: TRAINING ON FTCP DATA (70/30 Split)")
print("=" * 80)
sys.stdout.flush()
...
print("   ⚠️  WARNING: This will take 12-35 minutes! Be patient!")
...
print("\n" + "=" * 80)
print("EXPERIMENT 2: TRAINING ON SSL FEATURES (70/30 Split)")
print("=" * 80)
sys.stdout.flush()
...
print("   Expected time: 3-12 minutes (much faster than FTCP!)")
print(f"   ⏰ Training started at: {pd.Timestamp.now().strftime('%H:%M:%S')}")
print("   Computing (X^T X)^(-1) X^T y for linear regression...")
print("   You will see progress every 20 seconds below:")
print("")
...
print("\n" + "=" * 80)
print("COMPARISON: FTCP vs SSL FEATURES (70/30 Split)")
print("=" * 80)
sys.stdout.flush()
...
# Save JSON results
json_path = results_dir / "comparison_results_70_30.json"
...
csv_path = results_dir / "comparison_summary_70_30.csv"
results_df.to_csv(csv_path, index=False)
print(f"✅ Saved summary CSV: {csv_path}")

# Save predictions
np.save(results_dir / "ftcp_test_predictions_70_30.npy", y_test_pred_ftcp)
np.save(results_dir / "features_test_predictions_70_30.npy", y_test_pred_features)
np.save(results_dir / "test_true_labels_70_30.npy", y_test)
np.save(results_dir / "test_material_ids_70_30.npy", y_test_ids)
...
ax1.set_title(f'FTCP (70/30): Predicted vs Actual\nR² = {test_r2_ftcp:.4f}')
...
ax2.set_title(f'SSL Features (70/30): Predicted vs Actual\nR² = {test_r2_features:.4f}')
...
ax5.set_title('Performance Comparison (70/30 Test Set)')
ax5.set_xticks(x)
...
ax6.set_title('Computational Efficiency (70/30 Split)')
ax6.set_xticks(x)
...
sys.stdout.flush()
plt.tight_layout()
plot_path = results_dir / "comparison_plots_70_30.png"
...
report = f"""
{'=' * 80}
FORMATION ENERGY PREDICTION: FTCP vs SSL FEATURES (70/30 Split)
{'=' * 80}
...
Files Generated:
- comparison_results_70_30.json (detailed metrics)
- comparison_summary_70_30.csv (tabular summary)
- comparison_plots_70_30.png (visualizations)
- *_70_30.npy (predictions for further analysis)

{'=' * 80}
"""

report_path = results_dir / "COMPARISON_REPORT_70_30.txt"
...
print("\nFiles created:")
print("  - comparison_results_70_30.json")
print("  - comparison_summary_70_30.csv")
print("  - comparison_plots_70_30.png")
print("  - COMPARISON_REPORT_70_30.txt")
