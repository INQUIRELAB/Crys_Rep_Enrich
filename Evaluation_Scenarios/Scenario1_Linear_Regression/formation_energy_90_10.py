#!/usr/bin/env python3
"""
Compare FTCP vs SSL Features for Formation Energy Prediction (90/10 Split)
=============================================================================
...
print("\n" + "=" * 80)
print("EXPERIMENT 1: TRAINING ON FTCP DATA (90/10 Split)")
print("=" * 80)
sys.stdout.flush()
...
print("\n" + "=" * 80)
print("EXPERIMENT 2: TRAINING ON SSL FEATURES (90/10 Split)")
print("=" * 80)
sys.stdout.flush()
...
print("\n" + "=" * 80)
print("COMPARISON: FTCP vs SSL FEATURES (90/10 Split)")
print("=" * 80)
sys.stdout.flush()
...
# Save JSON results
json_path = results_dir / "comparison_results_90_10.json"
...
csv_path = results_dir / "comparison_summary_90_10.csv"
results_df.to_csv(csv_path, index=False)
print(f"✅ Saved summary CSV: {csv_path}")

# Save predictions
np.save(results_dir / "ftcp_test_predictions_90_10.npy", y_test_pred_ftcp)
np.save(results_dir / "features_test_predictions_90_10.npy", y_test_pred_features)
np.save(results_dir / "test_true_labels_90_10.npy", y_test)
np.save(results_dir / "test_material_ids_90_10.npy", y_test_ids)
...
ax1.set_title(f'FTCP (90/10): Predicted vs Actual\nR² = {test_r2_ftcp:.4f}')
...
ax2.set_title(f'SSL Features (90/10): Predicted vs Actual\nR² = {test_r2_features:.4f}')
...
ax5.set_title('Performance Comparison (90/10 Test Set)')
ax5.set_xticks(x)
...
ax6.set_title('Computational Efficiency (90/10 Split)')
ax6.set_xticks(x)
...
sys.stdout.flush()
plt.tight_layout()
plot_path = results_dir / "comparison_plots_90_10.png"
...
report = f"""
{'=' * 80}
FORMATION ENERGY PREDICTION: FTCP vs SSL FEATURES (90/10 Split)
{'=' * 80}
...
Files Generated:
- comparison_results_90_10.json (detailed metrics)
- comparison_summary_90_10.csv (tabular summary)
- comparison_plots_90_10.png (visualizations)
- *_90_10.npy (predictions for further analysis)

{'=' * 80}
"""

report_path = results_dir / "COMPARISON_REPORT_90_10.txt"
...
print("\nFiles created:")
print("  - comparison_results_90_10.json")
print("  - comparison_summary_90_10.csv")
print("  - comparison_plots_90_10.png")
print("  - COMPARISON_REPORT_90_10.txt")
